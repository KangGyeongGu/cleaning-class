...
import { StatCards } from "@/app/admin/traffic/StatCards";
import { TrafficTrendChart } from "@/app/admin/traffic/TrafficTrendChart.client";
import { BarPanel, type BarRow } from "@/app/admin/traffic/BarPanel.client";
import { DonutPanel } from "@/app/admin/traffic/DonutPanel.client";
import { DataControls } from "@/app/admin/traffic/DataControls.client";
import {
  getCloudflareDays,
  getGoAccessReport,
  aggregateCloudflare,
...
const sectionTitle =
  "mb-3 text-xs font-bold tracking-widest text-slate-500 uppercase";
  ...
  return (
    <div className="px-4 py-6 md:p-10">
      ...
      <section className="mb-4">
        ...
        <div className="mb-4 border border-slate-200 bg-white p-5">
