    ...
    <section className="border border-slate-200 bg-white">
      ...
      <dl className="divide-y divide-slate-100">
        {rows.map((row) => (
          ...
          >
            <dt className="text-xs font-bold tracking-widest text-slate-500 uppercase">
              {row.label}
            </dt>
            <dd
              className={
        ...
        <form action={formAction} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none border-b border-slate-200 bg-transparent pb-3 text-base font-light transition-colors outline-none placeholder:text-slate-300 focus:border-slate-900"
