export function PrivacyV20260323(): React.ReactElement {
  return (
    <>
      ...
      <section
        aria-labelledby="key-info-label-v1"
        className="mb-12 rounded-sm border border-slate-200 bg-slate-50 p-6"
      >
        <p id="key-info-label-v1" className="text-label mb-4 text-slate-500">
          주요 개인정보 처리 표시
        </p>
      ...
      <div className="space-y-12">
        <section aria-labelledby="article-1-v1">
          <h2 id="article-1-v1" className="text-heading-3 mb-4">
        ...
        <section aria-labelledby="article-2-v1">
          <h2 id="article-2-v1" className="text-heading-3 mb-4">
        ...
        <section aria-labelledby="article-3-v1">
          <h2 id="article-3-v1" className="text-heading-3 mb-4">
        ...
        <section aria-labelledby="article-4-v1">
          <h2 id="article-4-v1" className="text-heading-3 mb-4">
            제4조 (개인정보의 안전성 확보조치)
          </h2>
        ...
        <section aria-labelledby="article-5-v1">
          <h2 id="article-5-v1" className="text-heading-3 mb-4">
        ...
        <section aria-labelledby="article-6-v1">
          <h2 id="article-6-v1" className="text-heading-3 mb-4">
            제6조 (개인정보 처리방침의 변경)
          </h2>
          <div className="space-y-4 text-sm leading-relaxed font-light text-slate-700">
            <p>
